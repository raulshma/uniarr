...
const sonarrSettingsSchema = z.object({
  defaultProfileId: z.number().int().optional(),
  defaultRootFolderPath: z.string().optional(),
});

type SonarrSettingsFormValues = z.infer<typeof sonarrSettingsSchema>;
...
const SonarrSettingsScreen = () => {
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useForm<SonarrSettingsFormValues>({
    resolver: zodResolver(sonarrSettingsSchema),
    defaultValues: {
  ...
  const rootFoldersQuery = useQuery<RootFolder[]>({
    queryKey: queryKeys.sonarr.rootFolders(serviceId!),
  ...
  const saveSettingsMutation = useMutation<
    void,
    Error,
    SonarrSettingsFormValues
  >({
    mutationFn: async (values: SonarrSettingsFormValues) => {
      if (!serviceId) return;
    ...
    onSuccess: async () => {
      ...
      alert("Success", "Sonarr settings saved successfully.", [
  ...
  const onSubmit = useCallback(
    async (values: SonarrSettingsFormValues) => {
      ...
      >
        ...
        >
          <EmptyState
            ...
            description="We could not determine which Sonarr service to configure."
            actionLabel="Go back"
      ...
      >
        ...
        >
          <EmptyState
            ...
            description="We couldn't find a configured Sonarr connector for this service."
            actionLabel="Go back"
            onActionPress={() => router.back()}
          />
        </View>
      ...
      <View style={styles.container}>
        ...
        >
          <View>
            ...
            >
              Sonarr Default Settings
            </Text>
            <Text
              variant="bodyMedium"
              style={{ color: theme.colors.onSurfaceVariant }}
            >
              Configure default quality profile and root folder for new series.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            {qualityProfilesQuery.isLoading ? (
              ...
              <Controller<SonarrSettingsFormValues, "defaultProfileId">
                control={control}
          ...
          <View style={styles.section}>
            ...
            {rootFoldersQuery.isLoading ? (
              ...
              <Controller<SonarrSettingsFormValues, "defaultRootFolderPath">
                control={control}
...
export default SonarrSettingsScreen;
