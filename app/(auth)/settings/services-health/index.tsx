...
const CONFIGURABLE_SETTINGS = [
  ...
  },
  {
    id: "apiLoggerEnabled",
    title: "API Logger",
    description: "Log and track API activity",
    icon: "webhook",
    category: "diagnostics",
    stateSelector: (state: any) => state.apiLoggerEnabled,
    setAction: "setApiLoggerEnabled",
  },
  {
  ...
  {
    id: "apiLoggerCaptureRequestBody",
    title: "Log Request Bodies",
    description: "Include request bodies in API logs",
    icon: "file-document-edit",
    category: "diagnostics",
    stateSelector: (state: any) => state.apiLoggerCaptureRequestBody,
    setAction: "setApiLoggerCaptureRequestBody",
  },
  {
    id: "apiLoggerCaptureResponseBody",
    title: "Log Response Bodies",
    description: "Include response bodies in API logs",
    icon: "file-document-outline",
    category: "diagnostics",
    stateSelector: (state: any) => state.apiLoggerCaptureResponseBody,
    setAction: "setApiLoggerCaptureResponseBody",
  },
  {
    id: "apiLoggerCaptureRequestHeaders",
    title: "Log Request Headers",
    description: "Include request headers in API logs",
    icon: "file-chart",
    category: "diagnostics",
    stateSelector: (state: any) => state.apiLoggerCaptureRequestHeaders,
    setAction: "setApiLoggerCaptureRequestHeaders",
  },
