...
export const queryKeys = {
  unifiedSearch: {
    ...
    results: (
      ...
      [
        ...
        {
          term: term.trim(),
          services: options?.serviceIds
            ? [...options.serviceIds].sort()
            : undefined,
          mediaTypes: options?.mediaTypes
            ? [...options.mediaTypes].sort()
            : undefined,
        },
      ] as const,
  ...
  radarr: {
    ...
    queue: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.radarr.service(serviceId), "queue"] as const,
  },
  jellyseerr: {
    base: ["jellyseerr"] as const,
    service: (serviceId: string): QueryKeyBuilder =>
      ["jellyseerr", serviceId] as const,
    requestsList: (
      serviceId: string,
  ...
  jellyfin: {
    ...
    service: (serviceId: string): QueryKeyBuilder =>
      ["jellyfin", serviceId] as const,
    libraries: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.jellyfin.service(serviceId), "libraries"] as const,
    resume: (
      serviceId: string,
  ...
  qbittorrent: {
    ...
    service: (serviceId: string): QueryKeyBuilder =>
      ["qbittorrent", serviceId] as const,
    torrents: (
      serviceId: string,
      filters?: Record<string, unknown>,
    ): QueryKeyBuilder =>
  ...
  transmission: {
    ...
    service: (serviceId: string): QueryKeyBuilder =>
      ["transmission", serviceId] as const,
    torrents: (
      serviceId: string,
      filters?: Record<string, unknown>,
    ): QueryKeyBuilder =>
    ...
    transferInfo: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.transmission.service(serviceId), "transferInfo"] as const,
  },
  calendar: {
  ...
  tmdb: {
    ...
    genres: (mediaType: "movie" | "tv", language?: string): QueryKeyBuilder =>
      ["tmdb", "genres", mediaType, language ?? "default"] as const,
    details: (
      mediaType: "movie" | "tv",
      tmdbId: number,
      language?: string,
    ): QueryKeyBuilder =>
      ["tmdb", "details", mediaType, tmdbId, language ?? "default"] as const,
    videos: (
      mediaType: "movie" | "tv",
      tmdbId: number,
      language?: string,
    ): QueryKeyBuilder =>
      ["tmdb", "videos", mediaType, tmdbId, language ?? "default"] as const,
    images: (
      mediaType: "movie" | "tv",
      tmdbId: number,
      language?: string,
    ): QueryKeyBuilder =>
      ["tmdb", "images", mediaType, tmdbId, language ?? "default"] as const,
    watchProviders: (
      mediaType: "movie" | "tv",
      tmdbId: number,
    ): QueryKeyBuilder =>
      ["tmdb", "watchProviders", mediaType, tmdbId] as const,
    search: (
      term: string,
      options?: Record<string, unknown>,
    ): QueryKeyBuilder => ["tmdb", "search", term, options ?? {}] as const,
    person: {
      details: (personId: number, language?: string): QueryKeyBuilder =>
        ["tmdb", "person", "details", personId, language ?? "default"] as const,
      ...
      images: (personId: number): QueryKeyBuilder =>
        ["tmdb", "person", "images", personId] as const,
  ...
  bazarr: {
    ...
    service: (serviceId: string): QueryKeyBuilder =>
      ["bazarr", serviceId] as const,
    moviesList: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "movies"] as const,
    movieDetail: (serviceId: string, movieId: number): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "movies", movieId] as const,
    episodesList: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "episodes"] as const,
    episodeDetail: (serviceId: string, episodeId: number): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "episodes", episodeId] as const,
    subtitlesList: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "subtitles"] as const,
    ...
    languages: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "languages"] as const,
    providers: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "providers"] as const,
    profiles: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "profiles"] as const,
    queue: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "queue"] as const,
    history: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "history"] as const,
    statistics: (serviceId: string): QueryKeyBuilder =>
      [...queryKeys.bazarr.service(serviceId), "statistics"] as const,
    search: (
      serviceId: string,
      query: string,
      options?: Record<string, unknown>,
