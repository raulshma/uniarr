...
const createDiscoverId = (mediaType: DiscoverMediaKind, tmdbId: number | undefined): string => {
...
export const mapTmdbMovieToDiscover = (movie: MovieResult): DiscoverMediaItem => {
...
export const mapTmdbTvToDiscover = (series: TvResult): DiscoverMediaItem => {
  ...
  return {
    ...
    rating: typeof series.vote_average === 'number' ? series.vote_average : undefined,
    popularity: typeof series.popularity === 'number' ? series.popularity : undefined,
    releaseDate: series.first_air_date,
    year: extractYear(series.first_air_date),
    sourceId: series.id,
    tmdbId: series.id,
    voteCount: typeof series.vote_count === 'number' ? series.vote_count : undefined,
    source: 'tmdb',
  } satisfies DiscoverMediaItem;
};
