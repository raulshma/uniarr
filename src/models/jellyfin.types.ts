import type { components, paths } from '@/connectors/client-schemas/jellyfin-openapi';
...
export type JellyfinLibraryView = NonNullable<_JellyfinLibraryViewResponse['Items']>[number];

export type JellyfinUserData = components['schemas']['UserItemDataDto'];

export type JellyfinItem = components['schemas']['BaseItemDto'];

export type JellyfinItemsResponse<TItem = JellyfinItem> = components['schemas']['BaseItemDtoQueryResult'];

export type JellyfinResumeItem = JellyfinItem;

export type JellyfinLatestItem = JellyfinItem;

export type JellyfinImageOptions = paths['/Items/{itemId}/Images/{imageType}']['get']['parameters']['query'];
